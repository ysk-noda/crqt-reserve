...
function htmlResponse(title: string, message: string, isSuccess = false, status = 200): Response {
...
// GETリクエストを受け取り、即座に延長処理を実行して結果HTMLを返す
Deno.serve(async (req) => {
  ...
  // 後続予約との競合チェック（現在の end_time に開始する予約が存在するか）
